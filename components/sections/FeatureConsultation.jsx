...
import { Stethoscope, UserPlus, Check } from "lucide-react";
import { GradientText } from "../ui/aceternity";

export default function FeatureConsultation() {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true, margin: "-100px" });

  const features = [
    "أطباء متخصصين في أكثر من 20 تخصص طبي",
    "استشارة مجانية بالكامل بدون أي رسوم",
    "متابعة الحالة بشكل مستمر حتى التعافي",
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -top-5 -right-5 w-32 h-32 rounded-2xl bg-sky-100 -z-[1] animate-float-slow" />
            <Image
              src="/images/consultation-3d.png"
              alt="استشارة طبية مجانية"
              width={480}
              height={480}
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mb-4 leading-tight">
              استشارة طبية <GradientText>مجانية</GradientText> في أي وقت
            </h2>

            <p className="text-base text-slate-400 leading-relaxed mb-8">
              نوفر لك فريقاً من الأطباء المتخصصين المتطوعين في جميع التخصصات الطبية.
              يمكنك حجز استشارة طبية مجانية والحصول على التشخيص والعلاج المناسب.
            </p>
