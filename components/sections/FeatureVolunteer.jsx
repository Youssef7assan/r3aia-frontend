...
import { Heart, UserPlus, Gift, Check } from "lucide-react";
import { GradientText } from "../ui/aceternity";

export default function FeatureVolunteer() {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true, margin: "-100px" });

  const features = [
    "تطوع كطبيب لتقديم استشارات مجانية",
    "تطوع لتوصيل الأدوية للمرضى في منطقتك",
    "تبرع بمبلغ مالي لشراء الأدوية للمحتاجين",
    "ساعد في نشر المنصة للوصول لأكبر عدد",
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mb-4 leading-tight">
              تطوع أو <GradientText>تبرع</GradientText> لإنقاذ حياة
            </h2>

            <p className="text-base text-slate-400 leading-relaxed mb-8">
              يمكنك المساهمة في مساعدة المرضى المحتاجين بعدة طرق. سواء كنت طبيباً،
              متطوع توصيل، أو حتى متبرعاً - كل مساهمة تصنع فرقاً كبيراً في حياة إنسان.
            </p>
          ...
          >
            <div className="absolute -bottom-5 -left-5 w-32 h-32 rounded-2xl bg-sky-100 -z-[1] animate-float-slow" />
            <Image
